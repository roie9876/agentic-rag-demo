...
def render_enhanced_ai_foundry_tab(
    ...
    **kwargs
    ...
    st.header("🏭 AI Foundry Account Management (Full Version)")
    ...
    **💡 Focus**: This tab discovers and works with AI Foundry Accounts only - NO HUBS.
    ...
    st.write("🔍 DEBUG: Initializing services...")
    ...
    if 'ai_foundry_discovery_service' not in st.session_state:
        try:
            ...
            st.write("🔍 DEBUG: Discovery service initialized")
    ...
    st.write("🔍 DEBUG: Services initialized, creating tabs...")
...
def render_resource_discovery_section(discovery_service):
    ...
    st.success("✅ FULL VERSION LOADED - ALL FEATURES ACTIVE!")
    ...
    **🎯 Scanning for AI Foundry ACCOUNTS:**
    ...
    if not discovery_service:
        ...
        st.write("🔍 DEBUG: render_resource_discovery_section completed (early exit)")
        return
